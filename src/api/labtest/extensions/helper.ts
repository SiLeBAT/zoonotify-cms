import { ILabTestData, ILabTestDataAttributes, ILabTestsResponse, IRelation, IRelationDataAttributes } from "../models/response";


const toLinkedData = (data: ILabTestData[]): any => {
    var ldResponse = [];

    data.forEach((labTestData: ILabTestData) => {
        var rec: ILabTestDataAttributes = labTestData.attributes;
