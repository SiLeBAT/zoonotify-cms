export interface ILabTestsResponse {
    data: ILabTestData[]
}

export interface ILabTestData {
    id: number
    attributes: ILabTestDataAttributes
}

export interface ILabTestDataAttributes {
    year: number
    createdAt: any
    updatedAt: any
...
export interface IObjective extends IRelation {
}
